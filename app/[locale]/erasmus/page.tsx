  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white border-2 border-blue-200 rounded-lg p-6 hover:shadow-xl transition">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-bezmialem-blue">Öğrenci Öğrenim Hareketliliği</h2>
            </div>
            ...
            <div className="space-y-3">
              <div className="bg-blue-50 p-3 rounded">
                <h3 className="font-bold text-sm text-bezmialem-blue mb-1">Kimler Başvurabilir?</h3>
                <p className="text-sm text-gray-600">En az 1 yıl tamamlamış, min. 2.50 GPA, B1 dil seviyesi</p>
              </div>
              <div className="bg-blue-50 p-3 rounded">
                <h3 className="font-bold text-sm text-bezmialem-blue mb-1">Hibe Miktarı</h3>
                <p className="text-sm text-gray-600">490-600 EUR/ay + seyahat desteği (180-1.100 EUR)</p>
              </div>
              <div className="bg-blue-50 p-3 rounded">
                <h3 className="font-bold text-sm text-bezmialem-blue mb-1">Başvuru Dönemi</h3>
                <p className="text-sm text-gray-600">Güz: Şubat-Mart | Bahar: Eylül-Ekim</p>
              </div>
              <div className="bg-blue-50 p-3 rounded">
                <h3 className="font-bold text-sm text-bezmialem-blue mb-1">Avantajlar</h3>
          ...
          <div className="bg-white border-2 border-green-200 rounded-lg p-6 hover:shadow-xl transition">
            <div className="flex items-center mb-4">
              <div className="text-5xl mr-4">💼</div>
              <h2 className="text-2xl font-bold text-bezmialem-blue">Öğrenci Staj Hareketliliği</h2>
            </div>
            <p className="text-gray-700 mb-4">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-green-50 p-3 rounded">
                <h3 className="font-bold text-sm text-bezmialem-blue mb-1">Staj Süreleri</h3>
          ...
          <div className="bg-white border-2 border-purple-200 rounded-lg p-6 hover:shadow-xl transition">
            <div className="flex items-center mb-4">
              <div className="text-5xl mr-4">👨‍🏫</div>
              <h2 className="text-2xl font-bold text-bezmialem-blue">Personel Ders Verme</h2>
            </div>
            <p className="text-gray-700 mb-4">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-purple-50 p-3 rounded">
                <h3 className="font-bold text-sm text-bezmialem-blue mb-1">Süre</h3>
          ...
          <div className="bg-white border-2 border-orange-200 rounded-lg p-6 hover:shadow-xl transition">
            <div className="flex items-center mb-4">
              <div className="text-5xl mr-4">📚</div>
              <h2 className="text-2xl font-bold text-bezmialem-blue">Personel Eğitim Alma</h2>
            </div>
            <p className="text-gray-700 mb-4">
        ...
        <div className="bg-bezmialem-blue text-white p-8 rounded-xl">
            ...
            <div>
              ...
              <ol className="space-y-3 text-sm">
                <li className="flex items-start">
                  <span className="bg-white text-bezmialem-blue rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0 font-bold">1</span>
                  <span>Bölüm Erasmus Koordinatörünüzle görüşün</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-white text-bezmialem-blue rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0 font-bold">2</span>
                  <span>Partner üniversiteleri araştırın ve tercih yapın</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-white text-bezmialem-blue rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0 font-bold">3</span>
                  <span>Online başvuru formunu doldurun</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-white text-bezmialem-blue rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0 font-bold">4</span>
                  <span>Gerekli belgeleri hazırlayın (transkript, dil belgesi, motivasyon mektubu)</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-white text-bezmialem-blue rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0 font-bold">5</span>
                  <span>Öğrenim Anlaşması (Learning Agreement) hazırlayın</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-white text-bezmialem-blue rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0 font-bold">6</span>
                  <span>Seçim sonuçlarını bekleyin (2-3 hafta)</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-white text-bezmialem-blue rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0 font-bold">7</span>
                  <span>Kabul edilirseniz ev sahibi üniversiteye başvurun</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-white text-bezmialem-blue rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0 font-bold">8</span>
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded-r-lg">
          ...
          <ul className="space-y-2 text-sm text-gray-700">
            <li>• Erasmus+ hareketliliği için ev üniversitenize (Bezmialem) harç ödersiniz, ev sahibi üniversiteye harç ödemezsiniz</li>
            <li>• Aldığınız dersler ECTS kredisi olarak tanınır ve diplomanıza işlenir</li>
            <li>• Hareketlilik süresince Bezmialem öğrencisi olarak kalmaya devam edersiniz</li>
        ...
        <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
          <h2 className="text-2xl font-bold text-bezmialem-blue mb-4">İletişim ve Destek</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-bold mb-2">Kurumsal Erasmus Koordinatörü</h3>
              <p className="text-sm text-gray-700">
                <strong>E-posta:</strong> erasmus@bezmialem.edu.tr<br />
