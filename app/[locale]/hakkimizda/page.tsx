      ...
      <div className="space-y-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-brand-blue">
            ...
            <h3 className="text-xl font-bold text-brand-blue mb-2">4 Fakülte</h3>
            <p className="text-sm text-gray-700">Tıp, Diş Hekimliği, Eczacılık, Sağlık Bilimleri</p>
          </div>
          <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-600">
            <div className="text-4xl mb-3">🌍</div>
            <h3 className="text-xl font-bold text-brand-blue mb-2">50+ Ülke</h3>
            <p className="text-sm text-gray-700">Partner üniversiteler ve uluslararası öğrenciler</p>
          </div>
          <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-600">
            <div className="text-4xl mb-3">🤝</div>
            <h3 className="text-xl font-bold text-brand-blue mb-2">100+ Anlaşma</h3>
        ...
        <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-bold text-brand-blue mb-3">Öğrenci Hizmetleri</h3>
            ...
            <div>
              <h3 className="font-bold text-brand-blue mb-3">Kurumsal İşbirlikleri</h3>
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start">
                  <span className="text-brand-gold mr-2">✓</span>
        ...
        <div className="bg-gradient-to-br from-brand-blue to-blue-800 text-white p-8 rounded-xl">
