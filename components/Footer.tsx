    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <address className="not-italic space-y-2 text-sm">
              <p>Bezmialem Vakıf Üniversitesi</p>
              <p>Uluslararası İlişkiler Ofisi</p>
              <p>Adnan Menderes Bulvarı (Vatan Cad.)</p>
              <p>34093 Fatih/İstanbul</p>
              <p className="mt-4">
              ...
              <p>
                <a href="mailto:international@bezmialem.edu.tr" className="hover:text-white transition focus-visible-ring">
                  international@bezmialem.edu.tr
                </a>
              </p>
            </address>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/bezmialemvakifuniversitesi/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition focus-visible-ring" aria-label="Instagram">
              ...
              <a href="https://twitter.com/bezmialemvakif" target="_blank" rel="noopener noreferrer" className="hover:text-white transition focus-visible-ring" aria-label="Twitter">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Bezmialem Vakıf Üniversitesi. {t('rights')}</p>
        </div>
      </div>
    </footer>
  );
